...
class ChangeOfflinePinScreen extends StatefulWidget {
  const ChangeOfflinePinScreen({super.key});

  @override
  State<ChangeOfflinePinScreen> createState() => _ChangeOfflinePinScreenState();
}

class _ChangeOfflinePinScreenState extends State<ChangeOfflinePinScreen> {
  bool _obsOld = true;
  bool _obsNew = true;
